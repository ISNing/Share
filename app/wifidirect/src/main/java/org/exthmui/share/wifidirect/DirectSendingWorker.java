...
public class DirectSendingWorker extends SendingWorker {
    ...
    public Result doWork() {
        ...
        try {
            ...
            // Send fileTransfer
            Log.d(TAG, "Trying to connect to server(receiver) to send " + fileTransfer + " -> " + serverAddress[0].getHostAddress() + ":" + serverPort);
            ...
            if (inputStream == null) {
                return genFailureResult(Constants.TransmissionStatus.FILE_IO_ERROR.getNumVal(), "Failed reading file");
            }
